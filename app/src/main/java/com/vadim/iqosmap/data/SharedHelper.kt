package com.vadim.iqosmap.data

import android.content.Context
import android.content.SharedPreferences
import androidx.lifecycle.LiveData
import com.vadim.iqosmap.utils.CategoryEnum
import com.vadim.iqosmap.utils.SharedPreferenceLiveData
import com.vadim.iqosmap.utils.extentions.putBoolean
import com.vadim.iqosmap.utils.extentions.putStringSet
...
class SharedHelper(context: Context) {
    ...
    var enabledFilters: MutableSet<Int>
        get() = sharedPreferences.getStringSet(ENABLED_FILTERS, emptySet())!!.map { it.toInt() }.toMutableSet()
